...
id = 你的学号,
advisor = 你的指导老师,
work = {1）设计整体方案架构已完成初稿，涵盖系统主要模块及功能分布，结构清晰合理。2）技术选型报告正在编写，已调研多种技术方案，初步确定核心技术栈。3）详细设计计划制定中，明确了设计阶段时间安排和关键节点，确保后续工作有序推进。},
issue = {1）问题：设计方案存在部分模块功能重叠风险；思路：组织小组讨论，进行方案对比，优化模块职责划分。2）问题：技术选型难以兼顾性能与开发效率；思路：评估技术优缺点，结合项目需求优先考虑稳定成熟方案。},
plan = {1）完成技术选型报告，细化技术选型理由及备选方案分析。2）根据本周设计方案，开始详细设计文档编写，明确模块功能和接口。3）制定模块划分图和开发计划，为后续编码阶段做好准备。},
